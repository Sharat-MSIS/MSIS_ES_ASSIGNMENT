...
int main(void)
{
    ...
    /* Initialize LEDs connected to GPIOC */
    led_init();
    ...
    while (1)
    {
        ...
        /*
         * presscount selects the LED pattern.
         *
         * 0 = No pattern
         * 1 = Pattern 1
         * 2 = Pattern 2
        ...
        /*
         * pressed prevents the same button press
        ...
        if ((buttonstate == GPIO_PIN_RESET) && (pressed == 0))
        {
        ...
        {
            /* Allow next button press to be detected */
            pressed = 0;
        }
